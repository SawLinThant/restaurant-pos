          ...
          <div className="w-3/4 h-3/4">
            <form action="" className="w-full h-full flex flex-col gap-2">
              <div className="w-full h-full flex flex-col gap-4">
                ...
                <Input className="h-[2.75rem]" type="password" placeholder="Confirm Password" />
              </div>
              <div
              onClick={() => navigate('/login')}
              className="w-full text-center text-xs underline hover:cursor-pointer text-muted-foreground">Already have an account?</div>
              <Button className="w-full h-[2.75rem] p-4 mt-4 text-white bg-secondary hover:text-black hover:border-green-600">Register</Button>
            </form>
          </div>
        </div>
      </div>
